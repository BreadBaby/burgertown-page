(() => {
    ...
    function orderInit() {
        if (document.querySelector(".header__cart")) document.addEventListener("click", (function(e) {
    ...
    function addProductInit() {
        if (document.querySelector(".box__link")) document.addEventListener("click", (function(e) {
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        ...
        const langs = document.querySelectorAll(".header__linkLanguages"), wrapperLangs = document.querySelectorAll(".header__itemLanguages"), parentLangs = document.querySelector(".header__listlanguages"), form = document.querySelector(".form"), selectChildren = document.querySelectorAll(".select__option"), formAdress = document.querySelector(".form__adress").parentNode;
        ...
        parentLangs.addEventListener("click", (event => {
            ...
            if (target && target.classList.contains("header__linkLanguages")) langs.forEach(((item, i) => {
                if (target == item) {
                    if ("1" == item.parentElement.dataset.order) wrapperLangs.forEach((key => {
                    ...
                    })); else if ("3" == item.parentElement.dataset.order) wrapperLangs.forEach((key => {
                        key.dataset.order = +key.dataset.order - 1;
                        key.style.order = key.dataset.order;
        ...
        function hideAdress() {
            selectChildren.forEach((item => {
                if (item.hasAttribute("hidden") && "pickup" == item.getAttribute("data-value")) formAdress.style.display = "flex"; else formAdress.style.display = "none";
            }));
        }
        form.addEventListener("click", (e => {
            if (e.target && "BUTTON" == e.target.tagName) hideAdress();
        }));
        ...
        function updateFinalPrice(num, hold) {
            if (!hold) cartfinalPrice.textContent = +cartfinalPrice.textContent + +num;
        }
        bodyTabs.addEventListener("click", (e => {
            if (e.target && e.target.classList.contains("cell-items__link")) {
                let num, hold;
                if (e.target.classList.contains("_hold")) return hold = true;
                buttonAdd.forEach((elem => {
                    if (e.target == elem) return num = +elem.parentElement.previousElementSibling.innerHTML.match(/\d+/);
                }));
        ...
        parentBox.addEventListener("click", (e => {
            if (e.target && e.target.parentNode.classList.contains("item-table__close")) {
                ...
                arr.forEach((elem => {
                    if ("#text" != elem.nodeName && elem.classList.length < 3) {
                        setTimeout((function() {
        ...
        [].forEach.call(document.querySelectorAll('input[type="tel"]'), (function(input) {
            ...
            function mask(event) {
                ...
                let matrix = "+38(___)___-__-__", i = 0, def = matrix.replace(/\D/g, ""), val = this.value.replace(/\D/g, ""), new_value = matrix.replace(/[_\d]/g, (function(a) {
